...
git pull --ff-only
git status --short
git tag -a v0.3.0-beta.2 -m "Harako-RNAseq v0.3.0-beta.2 public beta"
git show v0.3.0-beta.2
...
- [ ] Verify exact `v0.3.0-beta.2` and floating `beta` tags.
