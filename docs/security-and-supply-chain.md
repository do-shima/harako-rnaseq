...
The current release-candidate review is recorded in
[vulnerability-review-v0.3.0-beta.2.md](vulnerability-review-v0.3.0-beta.2.md);
the beta.1 review remains historical evidence.
