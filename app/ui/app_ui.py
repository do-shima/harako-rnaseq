...
from app.ui.pages.reference import ReferencePageContext, render_reference_page
...
if st.session_state.step == 0:
    ...
    render_reference_page(
        ReferencePageContext(
            ...
            get_run_config=_get_run_config,
            update_run_config=updateRunConfig,
            cache_ref_paths=_cache_ref_paths,
            human_bytes=_human,
            load_manifest=_load_ref_manifest,
            normalize_reference=_normalize_ref,
            pick_candidate=_pick_ref_candidate,
            preset_releases=_preset_releases,
            reference_cache_root=_ref_cache_root,
            fetch_error_message=_ref_fetch_error_message,
            fetch_state_key=_ref_fetch_state_key,
            reference_state_snapshot=_ref_state_snapshot,
            reference_status_table=_ref_status_table,
            relative_path=_rel,
            scan_fastq=_scan_fastq_selected,
            scan_references=_scan_refs,
        )
